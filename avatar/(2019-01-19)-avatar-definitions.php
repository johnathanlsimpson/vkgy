<?php
	if($_SESSION['username'] === 'inartistic') {
		include_once("../avatar/avatar-options-inartistic.php");
	}
	else {
...
<svg version="1.1" id="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="600px" height="600px" viewBox="0 0 600 600" enable-background="new 0 0 600 600" xml:space="preserve" style="height: 0; width: 0; display: block;">
	...
	<defs>
		...
		<linearGradient id="avatar__gradient--rainbow">
			<stop offset="0%"  stop-color="hsla(0,   90%, 50%, 1)" />
			<stop offset="20%" stop-color="hsla(61,  90%, 50%, 1)" />
			<stop offset="30%" stop-color="hsla(61,  90%, 50%, 1)" />
			<stop offset="60%" stop-color="hsla(120, 70%, 55%, 1)" />
			<stop offset="75%" stop-color="hsla(210, 80%, 55%, 1)" />
			<stop offset="90%" stop-color="hsla(270, 80%, 55%, 1)" />
		</linearGradient>
