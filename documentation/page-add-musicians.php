<div class="col c1 documentation__wrapper">
	<div>
		...
		<input class="any--hidden obscure__input" id="obscure-doc-musicians" type="checkbox" checked />
		<div class="documentation__basic obscure__container obscure--alt obscure--height any--margin">
			...
			<label class="input__button obscure__button" for="obscure-doc-musicians">Show section</label>
		</div>
	</div>
</div>