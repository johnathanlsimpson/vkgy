...
$sql[] = '
RENAME TABLE views_daily_artists TO views_artists_daily;
RENAME TABLE views_weekly_artists TO views_artists_weekly;
RENAME TABLE views_monthly_artists TO views_artists_monthly;
RENAME TABLE views_daily_videos TO views_videos_daily;
RENAME TABLE views_weekly_videos TO views_videos_weekly;
RENAME TABLE views_monthly_videos TO views_videos_monthly;';
