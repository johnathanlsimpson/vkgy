...
<html>
    ...
    <!-- End Google Tag Manager (noscript) -->
		...
		<input class="any--hidden" id="language-en" name="language" type="radio" value="en" />
		<input class="any--hidden" id="language-ja" name="language" type="radio" value="ja" />
		
		<div class="col c1" style="background: var(--background); text-align: right;">
			<div>
				Language:
				<label class="input__checkbox-label symbol__unchecked" for="language-en" style="display: inline-block;">EN</label>
				<label class="input__checkbox-label symbol__unchecked" for="language-en" style="display: inline-block;">JA</label>
			</div>
		</div>
		<?php } ?>
