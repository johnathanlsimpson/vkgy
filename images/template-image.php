						...
						<div class="image__data any--flex-grow">
							...
							<div class="input__row" x-show="!showMusicians || !showReleases || !showArtists">
								<div class="input__group">
									...
									<a class="image__tag symbol__plus" data-tag-type="musicians" x-on:click.prevent="showMusicians=true; $dispatch('show-faces');" x-show="!showMusicians">musicians</a>
									<a class="image__tag symbol__plus" data-tag-type="releases" x-on:click.prevent="showReleases=true" x-show="!showReleases">releases</a>
									<a class="image__tag symbol__plus" data-tag-type="artists" x-on:click.prevent="showArtists=true" x-show="!showArtists">artists</a>
							...
							<div class="input__row" x-show="showMusicians">
								<div class="input__group">
									...
									<div class="image__faces any--flex">
										...
										<span class="face__loading loading">Detecting faces...</span>
										
										<a class="face__add a--outlined a--padded" href="" x-on:click.prevent="addFace=true"><span class="symbol__plus symbol--standalone"></span></a>
