											...
											for($i=0; $i<$num_edited_releases; $i++) {
												?>
													<li>
														<div class="h5">
															<?php
																echo $edited_releases[$i]['date_occurred'].' by '.'<a class="user a--inherit" href="/users/'.$edited_releases[$i]['username'].'/">'.$edited_releases[$i]['username'].'</a>';
															?>
														</div>
														<div>
															<a class="artist any--weaken-size" href="/releases/<?php echo $edited_releases[$i]["artist"]["friendly"]; ?>/">
																<?php echo $edited_releases[$i]["artist"]["quick_name"]; ?>
															</a>
															<br />
															<a class="symbol__release" href="/releases/<?php echo $edited_releases[$i]["artist"]["friendly"]."/".$edited_releases[$i]["id"]."/".$edited_releases[$i]["friendly"]; ?>/">
																<?php echo $edited_releases[$i]["quick_name"]; ?>
															</a>
														</div>
													</li>
												<?php
