												...
												?>
													<div class="h5" style="text-transform: none;">
														...
														<a class="artist" href="/artists/<?php echo $release["artist"]["friendly"]; ?>/"><?php
															if($release["artist"]["display_romaji"]) {
																echo $release["artist"]["display_romaji"]." (".$release["artist"]["display_name"].")";
															}
															elseif($release["artist"]["display_name"]) {
																				...
																				foreach($section["tracks"] as $track) {
																					...
																					--><?php
																									//if($track["artist"]["id"] != $release["artist"]["id"]) {
																										...
																										//if($_SESSION["username"] === "inartistic") { echo '<pre>'.print_r($track, true).print_r($release, true).'</pre>'; }
																									if(
