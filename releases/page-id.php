										...
										<div class="any--flex-grow">
											...
											<div class="input__row">
												<div class="data__item">
													...
													<a class="release__buy" href="<?= 'https://www.amazon.co.jp/s/ref=as_li_ss_tl?k='.urlencode(html_entity_decode($release['artist']['name'].' '.$release['name'])).'&tag=vkgy-22'; ?>" rel="nofollow" target="_blank">
