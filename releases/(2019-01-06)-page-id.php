					...
					<div>
						...
						<div class="text">
							<form action="/php/function-add_comment.php" enctype="multipart/form-data" method="post" name="form__comment">
								<input name="item_type" type="hidden" value="release" />
								<input name="item_id" type="hidden" value="<?php echo $release["id"]; ?>" />
											...
											<li class="comment__template" data-get="thread_id" data-get-into="data-thread-id" data-thread-id="<?php $n = 0; echo $args[$n]; ?>">
												...
												<div class="any--flex any--flex-space-between">
													<div class="h5">
														...
														<span data-get="date_occurred"><?php $n++; echo $args[$n]; ?></span>
													</div>
													<span>
							...
							<ul class="comment__container">
								<?php
									if(is_array($release["comments"])) {
										foreach($release["comments"] as $comment_thread) {
				...
				<div>
					...
					<?php
						...
						if($_SESSION["loggedIn"]) {
							...
							$stmt_user_tags->execute([ $release["id"], $_SESSION["userID"] ]);
