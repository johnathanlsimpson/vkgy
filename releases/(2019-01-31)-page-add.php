			...
			<div class="any--flex input__row" data-role="submit-container">
				...
				<?php
					if($_SESSION["admin"] > 1) {
						?>
							<div class="input__group">
								<input class="input__checkbox" id="stealth" name="stealth" type="checkbox" value="1" />
								<label class="add__stealth input__checkbox-label symbol__unchecked" for="stealth">Stealth?</label>
							</div>
						<?php
					}
				?>
