			...
			<div class="col c1">
				<div>
					<div class="text text--outlined text--notice">
						Sorry, <?php echo $_SESSION["loggedIn"] ? '<a class="user" href="/users/'.$_SESSION["username"].'/">'.$_SESSION["username"].'</a>,' : null; ?> the VIP section is limited to members who <a href="https://patreon/vkgy/" target="_blank">support vkgy at Patreon</a> for <span class="any__note">$5+ / month</span>.<br /><br />
