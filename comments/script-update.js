class CommentHandler {
	...
	populateComment(commentElem, commentData) {
		...
		if(commentIdInput) {
			commentIdInput.value = commentData.commentId ? commentData.commentId : null;
		}
	...
	editInline(editButton) {
		...
		newCommentateTemplate = this.populateComment(newCommentateTemplate, editCommentData);
		
		// Attach handler to new submit button
		this.initCommentButton('submit', newCommentateTemplate.querySelector('.comment__submit'));
