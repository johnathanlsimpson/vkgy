...
// Get shared elements
let songForm = document.querySelector('[name="add-song"]');
...
// Submit additions
initializeInlineSubmit($(songForm), '/songs/function-add.php', {
	...
	callbackOnSuccess: function(formElem, returnedData) {
		...
		// Clear all songs and hints
		let elemsToClear = document.querySelectorAll('[data-clear-on-success]');
