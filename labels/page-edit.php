		...
		?>
			<div class="col c1">
				<form action="/labels/function-edit.php" enctype="multipart/form-data" method="post" name="form__edit">
					...
					<h1>
						Edit <a class="a--inherit symbol__company" data-get="edit_url" data-get-into="href" href="/labels/<?php echo $label["friendly"]; ?>/"><span data-get="quick_name"><?php echo $label["quick_name"]; ?></span></a>
					</h1>
